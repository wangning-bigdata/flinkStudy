...
/**
 * 基于间隔的Join
 * Created by wangning on 2021/11/22 14:45.
 */
public class Example4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Event> orderStream = env.fromElements(Event.of("user-1", "order", 20 * 60 * 1000L))
        ...
        SingleOutputStreamOperator<Event> pvStream = env.fromElements(
                ...
                Event.of("user-1", "pv", 24 * 60 * 1000L)
